...
::: info 相关 topic
- [EIP-4337](https://eips.ethereum.org/EIPS/eip-4337)：标准原文，适合理解 `UserOperation`、EntryPoint、Bundler 和 Paymaster。
- [ERC-4337 Documentation](https://docs.erc4337.io/)：开发者文档，适合了解账户抽象组件和生态实现。
:::
...
::: info 相关 topic
- [钱包（Wallet）](/zh/handbook/web3/wallet/)：先理解 EOA、签名、交易和 gas 的基础体验。
- [智能合约（Smart Contract）](/zh/handbook/web3/smart-contract/)：Smart Account 本质上也是管理资产和权限的合约系统。
:::
...
- [EIP-4337](https://eips.ethereum.org/EIPS/eip-4337)：账户抽象标准原文。
- [ERC-4337 Documentation](https://docs.erc4337.io/)：开发者视角理解 EntryPoint、Bundler、Paymaster 和 Smart Account。
- [Ethereum Account Abstraction](https://ethereum.org/en/roadmap/account-abstraction/)：从以太坊路线图角度理解账户抽象为什么重要。
- [Safe Smart Accounts](https://docs.safe.global/)：了解多签和智能账户在真实项目中的使用方式。
- [Rhinestone Smart Sessions](https://docs.rhinestone.dev/smart-wallet/smart-sessions/overview)：学习 session key、权限策略和模块化智能账户设计。
