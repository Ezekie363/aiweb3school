...
::: info 相关 topic
- [Ethereum Blocks](https://ethereum.org/en/developers/docs/blocks/)：理解区块、交易批处理、区块时间和区块 gas 限制。
:::
...
::: info 相关 topic
- [Ethereum Proof-of-Stake](https://ethereum.org/en/developers/docs/consensus-mechanisms/pos/)：了解以太坊 PoS、验证者、区块提议和惩罚机制。
:::
...
- [Ethereum Blocks](https://ethereum.org/en/developers/docs/blocks/)：理解区块如何组织交易和状态变化。
- [Ethereum Networks](https://ethereum.org/en/developers/docs/networks/)：了解主网、测试网和网络 ID。
- [Ethereum Proof-of-Stake](https://ethereum.org/en/developers/docs/consensus-mechanisms/pos/)：学习以太坊当前共识机制。
- [Ethereum Layer 2](https://ethereum.org/en/layer-2/)：从用户和开发者角度理解 L2。
- [Ethereum Rollups](https://ethereum.org/en/developers/docs/scaling/#rollups)：继续看 rollup 为什么是主流扩展路径。
