...
::: info 相关 topic
- [Remix Documentation](https://remix-ide.readthedocs.io/)：官方文档，适合入门 Remix 工作区、编译器、Deploy & Run、debugger 和插件。
- [Remix Online IDE](https://remix.ethereum.org/)：浏览器版 IDE，可以直接写、编译和部署 Solidity 合约。
:::
...
::: info 相关 topic
- [Hardhat Documentation](https://hardhat.org/docs)：官方文档，重点看 getting started、testing、deploying、configuration variables 和 contract verification。
:::
...
::: info 相关 topic
- [Foundry Book](https://book.getfoundry.sh/)：官方文档，适合学习 `forge`、`cast`、`anvil`、fuzz testing 和 fork testing。
:::
...
- [OpenZeppelin Contracts](https://docs.openzeppelin.com/contracts/)：官方合约库文档，适合学习 ERC 标准实现、AccessControl、Ownable、Pausable 等模块。
- [OpenZeppelin Upgrades](https://docs.openzeppelin.com/upgrades-plugins/)：了解 proxy 升级流程和升级合约的风险边界。
:::
...
::: info 相关 topic
- [viem Documentation](https://viem.sh/)：学习 TypeScript 方式读取链、编码调用、发送交易和处理链上数据。
- [wagmi Documentation](https://wagmi.sh/)：学习 React 应用里的钱包连接、账户状态、合约读写和交易状态管理。
:::
