...
::: info 相关 topic
- [RAG](/zh/handbook/ai/rag/)：继续看 embedding 如何进入检索增强生成系统。
...
::: info 相关 topic
- [Evaluation](/zh/handbook/ai/evaluation/)：用测试集和回归评估持续捕捉模型错误。
- [AI Security](/zh/handbook/bridge/ai-security/)：看模型错误和攻击输入进入工具执行后的风险。
:::
